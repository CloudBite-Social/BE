...
func (_m *Repository) GetById(ctx context.Context, id uint) (*users.User, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Repository) Login(ctx context.Context, email string) (*users.User, error) {
...
func (_m *Repository) Register(ctx context.Context, data users.User) error {
...
func (_m *Repository) Update(ctx context.Context, id uint, data users.User) error {
